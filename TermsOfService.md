...
### **WARNING** Data Integrity & Liability
Manual manipulation of data and objects within a database can lead to a loss or corruption of that data and/or objects. This may result in unintended/undesirable consequences for the app which the database is associated with. SQLiteDevStudio is a tool for manually creating, editing and deleting databases, associated data, and database objects. By using the services within SQLiteDevStudio the user accepts full responsibility for any database loss or corruption.
